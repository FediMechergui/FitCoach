...
It ships with a **357-exercise library** split by muscle group, **individual muscle**
...
Every formula above is exercised by `npm run verify:engines` (**190 checks**), which
...
- **Per-muscle library (357 exercises)** — every muscle individually: traps (shrugs, high
...
- **357 exercises** ([src/data/exercises.ts](src/data/exercises.ts)) organized by muscle
...
pointing at the right exercise even as the library grows from 46 to 357 entries.
...
- **Phase 1 (this build):** universal sessions, full activity library, stats,
  ...
  357-exercise library with beginner guides, training splits, a Tunisian food

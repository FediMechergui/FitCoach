...
It ships with a **481-exercise library** split by muscle group, **individual muscle**
...
- **Per-muscle library (481 exercises)** — every muscle individually: traps (shrugs, high
...
- **481 exercises** ([src/data/exercises.ts](src/data/exercises.ts)) organized by muscle
...
pointing at the right exercise even as the library grows from 46 to 481 entries.
...
- **Phase 1 (this build):** universal sessions, full activity library, stats,
  ...
  481-exercise library with beginner guides, training splits, a Tunisian food

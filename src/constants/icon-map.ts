...
export const ICONS = {
  ...
  mindbody: {
    ...
    // Special-programme icons (military / historical / lifestyle)
    special: def('MaterialCommunityIcons', 'shield-star'),
    military: def('MaterialCommunityIcons', 'shield-cross'),
    tactical: def('MaterialCommunityIcons', 'shield-account'),
    seal: def('MaterialCommunityIcons', 'anchor'),
    spetsnaz: def('MaterialCommunityIcons', 'snowflake'),
    commando: def('MaterialCommunityIcons', 'bugle'),
    roman: def('MaterialCommunityIcons', 'pillar'),
    spartan: def('MaterialCommunityIcons', 'shield-sword' as never),
    shaolin: def('MaterialCommunityIcons', 'yin-yang'),
    wrestler: def('MaterialCommunityIcons', 'human-greeting-proximity'),
    aztec: def('MaterialCommunityIcons', 'terrain'),
    viking: def('MaterialCommunityIcons', 'sword-cross'),
    samurai: def('MaterialCommunityIcons', 'sword'),
    medal: def('MaterialCommunityIcons', 'medal'),
    office: def('MaterialCommunityIcons', 'briefcase-outline'),
    morning: def('MaterialCommunityIcons', 'coffee-outline'),
    travel: def('MaterialCommunityIcons', 'airplane'),
    mongol: def('MaterialCommunityIcons', 'bow-arrow'),
    gladiator: def('MaterialCommunityIcons', 'shield-sword' as never),
    ninja: def('MaterialCommunityIcons', 'ninja'),
    firefighter: def('MaterialCommunityIcons', 'fire-truck'),
    prison: def('MaterialCommunityIcons', 'weight-lifter'),
    // Superhero & screen legends
    hero: def('MaterialCommunityIcons', 'lightning-bolt'),
    saitama: def('MaterialCommunityIcons', 'emoticon-neutral-outline'),
    batman: def('MaterialCommunityIcons', 'bat'),
    brucelee: def('MaterialCommunityIcons', 'karate'),
    rocky: def('MaterialCommunityIcons', 'boxing-glove'),
    shield: def('MaterialCommunityIcons', 'shield-half-full'),
    legion: def('MaterialCommunityIcons', 'parachute'),
    islamic: def('MaterialCommunityIcons', 'star-crescent'),
    chinese: def('MaterialCommunityIcons', 'sword-cross'),
    egypt: def('MaterialCommunityIcons', 'pyramid'),
    tribe: def('MaterialCommunityIcons', 'shield-outline'),
    bodybuilder: def('MaterialCommunityIcons', 'arm-flex'),
    ...
    // World cultures — one glyph each, all verified present in the MCI set
    inuit: def('MaterialCommunityIcons', 'snowflake-variant'),
    amazon: def('MaterialCommunityIcons', 'forest'),
    plains: def('MaterialCommunityIcons', 'feather'),
    raramuri: def('MaterialCommunityIcons', 'run-fast'),
    persian: def('MaterialCommunityIcons', 'crown'),
    pehlwan: def('MaterialCommunityIcons', 'om'),
    sikh: def('MaterialCommunityIcons', 'shield-crown'),
    sumo: def('MaterialCommunityIcons', 'weight'),
    maori: def('MaterialCommunityIcons', 'sail-boat'),
    maasai: def('MaterialCommunityIcons', 'spear'),
    turkish: def('MaterialCommunityIcons', 'star-crescent'),
    celtic: def('MaterialCommunityIcons', 'axe'),
    hwarang: def('MaterialCommunityIcons', 'flower-tulip'),
    inca: def('MaterialCommunityIcons', 'terrain'),
    kali: def('MaterialCommunityIcons', 'sword-cross'),
    aboriginal: def('MaterialCommunityIcons', 'boomerang'),
    thai: def('MaterialCommunityIcons', 'elephant'),
    luchador: def('MaterialCommunityIcons', 'drama-masks'),

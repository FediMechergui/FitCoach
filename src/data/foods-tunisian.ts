...
export const TUNISIAN_FOODS: FoodItem[] = [
  ...
  // ── Dried fruits ───────────────────────────────────────────────────────────
  F('df-raisins', 'Raisins', '40 g (small box)', 120, 1.2, 32, 0.2, 1.5, 'Dried fruit'),
  F('df-golden-raisins', 'Golden Raisins / Sultanas', '40 g', 122, 1.3, 32, 0.1, 1.5, 'Dried fruit'),
  F('df-prunes', 'Prunes (dried plums)', '40 g (~4)', 96, 0.9, 26, 0.1, 2.8, 'Dried fruit'),
  F('df-dried-fig', 'Dried Figs', '40 g (~3)', 100, 1.3, 26, 0.4, 4, 'Dried fruit'),
  F('df-dried-apricot', 'Dried Apricots', '40 g (~8)', 96, 1.4, 25, 0.2, 3, 'Dried fruit'),
  F('df-dried-date', 'Dried Dates', '40 g (~2)', 113, 1, 30, 0.2, 3.2, 'Dried fruit'),
  F('df-dried-cranberry', 'Dried Cranberries', '40 g', 123, 0.1, 33, 0.5, 2.3, 'Dried fruit'),
  F('df-dried-mango', 'Dried Mango', '40 g', 128, 1.5, 32, 0.4, 2, 'Dried fruit'),
  F('df-dried-banana', 'Dried Banana', '40 g', 138, 0.7, 35, 0.7, 3, 'Dried fruit'),
  F('df-banana-chips', 'Banana Chips (fried)', '40 g', 208, 1, 23, 13, 3, 'Dried fruit'),
  F('df-dried-pineapple', 'Dried Pineapple', '40 g', 132, 0.6, 34, 0.3, 1.5, 'Dried fruit'),
  F('df-dried-apple', 'Dried Apple Rings', '40 g', 96, 0.4, 26, 0.1, 3.5, 'Dried fruit'),
  F('df-dried-coconut', 'Dried Coconut (shredded)', '30 g', 200, 2, 7, 19, 5, 'Dried fruit'),
  F('df-dried-berries', 'Dried Mixed Berries', '40 g', 120, 1, 30, 0.5, 3, 'Dried fruit'),
  F('df-fruit-mix', 'Dried Fruit & Nut Mix', '40 g', 180, 4, 20, 10, 3, 'Dried fruit'),

  // ── Mloukhia & lesser-known Tunisian dishes ─────────────────────────────────
  F('tn-mloukhia-beef', 'Mloukhia bil Lahm (beef)', '350 g plate', 480, 32, 20, 30, 6, 'Tunisian dish'),
  F('tn-mloukhia-chicken', 'Mloukhia bil Djaj (chicken)', '350 g plate', 430, 34, 18, 25, 6, 'Tunisian dish'),
  F('tn-mloukhia-veg', 'Mloukhia (vegetarian)', '300 g plate', 250, 8, 20, 16, 7, 'Tunisian dish'),
  F('tn-marqet-jelbana', 'Marqet Jelbana (pea & meat stew)', '350 g plate', 380, 24, 30, 17, 8, 'Tunisian dish'),
  F('tn-marqa-loubia', 'Loubia (white bean stew)', '350 g plate', 330, 18, 42, 9, 12, 'Tunisian dish'),
  F('tn-kammounia', 'Kammounia (cumin liver stew)', '300 g plate', 340, 30, 12, 19, 3, 'Tunisian dish'),
  F('tn-marqa-hlou', 'Marqa Hlou (sweet lamb & fruit stew)', '350 g plate', 470, 26, 45, 20, 6, 'Tunisian dish'),
  F('tn-nwasser', 'Nwasser (small pasta stew)', '350 g plate', 430, 16, 65, 12, 5, 'Tunisian dish'),
  F('tn-mhamsa', 'Mhamsa (hand-rolled couscous)', '300 g plate', 460, 16, 78, 9, 7, 'Tunisian dish'),
  F('tn-douwida', 'Douwida (vermicelli soup)', '300 g bowl', 260, 9, 45, 5, 3, 'Tunisian dish'),
  F('tn-chakchouka', 'Chakchouka (peppers, tomato & egg)', '300 g plate', 260, 12, 16, 16, 4, 'Tunisian dish'),
  F('tn-madfouna', 'Madfouna (chard & bean stew)', '300 g plate', 300, 14, 34, 12, 10, 'Tunisian dish'),
  F('tn-osban', 'Osban (Tunisian stuffed sausage)', '150 g', 330, 18, 20, 20, 3, 'Tunisian dish'),
  F('tn-pate', 'Pâté (liver spread)', '30 g', 90, 4, 1, 8, 0, 'Spread'),
  F('tn-pate-sandwich', 'Pâté Sandwich (baguette)', '1 sandwich', 480, 16, 60, 20, 4, 'Sandwich'),

  // ── Traditional drinks & porridges ──────────────────────────────────────────
  F('tn-droo', 'Droô (sorghum drink)', '250 ml', 180, 5, 34, 3, 3, 'Tunisian drink'),
  F('tn-bsisa-drink', 'Bsisa Drink (with milk & oil)', '250 ml', 300, 9, 40, 12, 5, 'Tunisian drink'),
  F('tn-zrir', 'Zrir (nut & sesame paste)', '30 g', 150, 4, 12, 10, 2, 'Tunisian sweet'),
  F('tn-assida-boufriwa', 'Assidat Boufriwa (hazelnut/pine assida)', '150 g bowl', 420, 8, 45, 24, 4, 'Tunisian sweet'),
  F('tn-assida-zgougou-full', 'Assidat Zgougou (topped)', '150 g bowl', 400, 9, 46, 21, 5, 'Tunisian sweet'),
  F('tn-droo-assida', 'Assida Droô (sorghum porridge)', '150 g bowl', 300, 7, 50, 8, 4, 'Tunisian sweet'),

  // ── Eid & festive homemade cookies ──────────────────────────────────────────
  F('tn-ghraiba-homs', 'Ghraïba Homs (chickpea)', '1 piece (20 g)', 100, 2, 12, 5, 1, 'Eid cookie'),
  F('tn-ghraiba-dhra', 'Ghraïba Droô (sorghum)', '1 piece (20 g)', 98, 1.5, 13, 4.5, 1, 'Eid cookie'),
  F('tn-ghraiba-flour', 'Ghraïba Flour (semolina/butter)', '1 piece (20 g)', 110, 1.5, 12, 6.5, 0.5, 'Eid cookie'),
  F('tn-baklawa', 'Baklawa (Tunisian)', '1 piece (30 g)', 140, 2.5, 16, 8, 1, 'Eid cookie'),
  F('tn-kaak-warka', 'Kaâk Warka (almond ring)', '1 piece (25 g)', 115, 2.5, 14, 6, 1, 'Eid cookie'),
  F('tn-samsa', 'Samsa (almond & sesame triangle)', '1 piece (25 g)', 120, 2.5, 15, 6, 1, 'Eid cookie'),
  F('tn-makroudh-el-louz', 'Makroudh El Louz (almond)', '1 piece (30 g)', 140, 3, 16, 7.5, 1.5, 'Eid cookie'),
  F('tn-kaak-neqache', 'Kaâk Neqache (ringed cookie)', '1 piece (40 g)', 160, 3, 24, 6, 1, 'Eid cookie'),
  F('tn-mlabes', 'Mlabes (marzipan sweets)', '1 piece (15 g)', 65, 1, 10, 2.5, 0.5, 'Eid cookie'),
  F('tn-boulou', 'Boulou (Tunisian cake bread)', '60 g slice', 210, 5, 34, 6, 2, 'Eid cookie'),
  F('tn-dides', 'Debla / Dides (fried rosettes)', '1 piece (25 g)', 130, 1.5, 16, 7, 0.5, 'Eid cookie'),
  F('tn-kaak-warka-box', 'Assorted Eid Cookies (plate)', '100 g', 470, 9, 55, 24, 3, 'Eid cookie'),
];

...
const DISH_HEURISTICS: DishHeuristic[] = [
  ...
  { keywords: ['cordon bleu'], calories: 360, protein: 22, carbs: 18, fat: 22 },
  { keywords: ['halwa', 'chamia', 'halva'], calories: 155, protein: 4, carbs: 15, fat: 9 },
  { keywords: ['hummus', 'hommos'], calories: 80, protein: 2.4, carbs: 6, fat: 5 },

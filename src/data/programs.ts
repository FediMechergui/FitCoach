...
export const PROGRAMS: TrainingProgram[] = [
  ...
  },
  {
    ...
    days: [
      ...
      { key: 'clinch', label: 'Clinch & takedowns', purpose: 'The phase most strikers lose and most grapplers win.', exercises: ['ma-clinch-work', 'ma-takedown-entries', 'sprawl-drill'], prescription: '8×3 min clinch rounds', minutes: 50, method: 'ma-clinch' },

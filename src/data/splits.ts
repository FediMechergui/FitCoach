  ...
  },
  {
    ...
    days: [
      ...
      },
      {
        ...
        blurb: 'Biceps, triceps and forearms — the whole arm.',
        exercises: ['barbell-curl', 'skullcrusher', 'hammer-curl', 'triceps-pushdown', 'incline-db-curl', 'db-overhead-extension', 'reverse-curl', 'barbell-wrist-curl', 'reverse-wrist-curl', 'farmers-hold'],
      },
      {
        key: 'legs',
        label: 'Leg Day',
      ...
      },
      {
        ...
        label: 'Abs Day',
        muscles: ['core'],
        blurb: 'The whole midsection — upper, lower and obliques.',
        exercises: ['hanging-leg-raise', 'cable-crunch', 'reverse-crunch', 'bicycle-crunch', 'cable-woodchopper', 'plank', 'side-plank', 'hollow-rock'],
      },
    ],
  },
  {
